package src {
    ...
    public class AESBase64 {
        ...
        public function AESBase64(_arg1:Number, _arg2:Number){
        ...
        public static function encodeBase64(_arg1:Array):String{
            var _local4:Number;
            var _local5:Number;
            var _local6:Number;
            var _local7:Number;
        ...
        public static function utf8Encode(_arg1:String):Array{
            var _local6:Number;
            var _local2 = "";
            var _local3:Number = 0;
            while (_local3 < _arg1.length) {
        ...
        public static function decodeBase64(_arg1:String):Array{
            var _local4:Number;
            var _local5:Number;
            var _local6:Number;
            var _local7:Number;
        ...
        public static function utf8Decode(_arg1:Array):String{
            var _local2 = "";
            var _local3:Number = 0;
        ...
        private function padBuffer(_arg1:Array):void{
        ...
        private function removePad(_arg1:Array):void{
            var _local2:Number = (blockSize / 8);
